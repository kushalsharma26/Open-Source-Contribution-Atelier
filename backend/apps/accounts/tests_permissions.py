...
from apps.accounts.permissions import IsAdminRole, IsModeratorRole, IsAdminOrModeratorRole
...
class UserListViewTests(TestCase):
    def setUp(self):
        ...
        # Create users
        self.regular_user = User.objects.create_user(username='regular2', password='password')
        
        self.admin_user = User.objects.create_user(username='admin2', password='password')
        self.admin_user.groups.add(self.admin_group)
        
        self.moderator_user = User.objects.create_user(username='moderator2', password='password')
        self.moderator_user.groups.add(self.moderator_group)
        
        self.staff_user = User.objects.create_user(username='staff2', password='password', is_staff=True)
